    ...
    <div class="col">
        <div class="card shadow">
            ...
            <div class="card-footer ">
                <button type="button" id="btnAdd" class="float-end btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addCamera">
            ...
            <!--Modal -->
            <div class="modal fade text-left" id="addCamera" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input name="gate_number" id="gate_number" type="text" placeholder="Nomor Gate" class="@error('gate_number')is-invalid @enderror form-control">
                        @error('gate_number')
                        ...
                        <div class="form-group">
                        <input name="ip_camera_top" id="camera_top" type="text" placeholder="IP Kamera Atas" class="@error('ip_camera_top')is-invalid @enderror form-control">
                        @error('ip_camera_top')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
                        ...
                        <div class="form-group">
                        <input name="ip_camera_side" id="camera_side" type="text" placeholder="IP Kamera Bawah" class="@error('ip_camera_side')is-invalid @enderror form-control">
