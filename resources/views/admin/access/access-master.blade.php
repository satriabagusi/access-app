    ...
    <div class="col-12">
                    ...
                    <tbody>
                        @foreach ($masterAccess as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('/dashboard/master-access/card/'.$item->id)}}" class="btn btn-sm btn-danger">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        @endif
            <div class="card-footer bg-white">
                ...
                @else
                <button class="float-end btn btn-primary mb-2" disabled>Tambah Kartu Master</button>
                @endif
            </div>
                </div>
            </div>
