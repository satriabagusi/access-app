                            ...
                            <div class="row">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <div class="row justify-content-evenly">
                                        <div class="col-auto">
                                            <input class="form-check-input @error('user_role_id') is-invalid @enderror" type="radio" name="user_role_id" id="user_role_id1" value="1">
                                            <label class="form-check-label" for="user_role_id1">Admin</label>
                                        </div>
                                        <div class="col-auto">
                                            <input class="form-check-input @error('user_role_id') is-invalid @enderror" type="radio" name="user_role_id" id="user_role_id2" value="2">
                                            <label class="form-check-label" for="user_role_id2">Admin DCU</label>
                                        </div>
                                        <div class="col-auto">
                                            <input class="form-check-input @error('user_role_id') is-invalid @enderror" type="radio" name="user_role_id" id="user_role_id3" value="3">
