...
@endpush
@section('content')
<video autoplay muted loop id="myVideo" poster="{{ asset('img/bg-display.jpg') }}">
...
<div class="row justify-content-center mt-5">
    ...
    <!-- Modal Area Terbatas -->
    <div class="modal fade" id="modalRestrictArea" tabindex="-1" aria-labelledby="modalRestrictAreaLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable " style="max-width: 70% !important;">
            <div class="modal-content">
